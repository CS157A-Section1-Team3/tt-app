     ...
     String db = "Time";
        ...
        try {
          ...
          //  out.println("Initial entries in table SHIFT: <br/>");
            ...
            ResultSet rs = stmt.executeQuery("SELECT Users.Username, department.name, team.name, Project.name FROM Time.Users, Time.department, Time.team, Time.Project, Time.Workingon WHERE Users.DepartmentID = department.ID AND team.ProjectID = Project.Id AND team.teamID = Workingon.teamID AND Workingon.UserID = Users.ID AND Workingon.ProjectID = Project.Id");
            while (rs.next()) {
