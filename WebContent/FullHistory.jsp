     ...
     String db = "Time";
        ...
        try {
          ...
          //  out.println("Initial entries in table SHIFT: <br/>");
            ...
            ResultSet rs = stmt.executeQuery("SELECT SHIFT.Id, SHIFT.pid, SHIFT.start, SHIFT.end, Hours.hWorked FROM ttapp.SHIFT, ttapp.Hours WHERE SHIFT.Id = Hours.SHIFTId;");
            while (rs.next()) {
