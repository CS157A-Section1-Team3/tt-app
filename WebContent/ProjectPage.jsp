  ...
  <form class="contact100-form validate-form">
     ...
     String db = "Time";
        ...
        try {
          ...
          //  out.println("Initial entries in table SHIFT: <br/>");
            ...
            ResultSet rs = stmt.executeQuery("SELECT team.ProjectID, team.teamID, team.name, Project.name FROM ttapp.Project, ttapp.team WHERE team.ProjectID = Project.Id");
            while (rs.next()) {
    ...
    <div class="container-contact100-form-btn">
      <button class="contact100-form-btn">
        <span>
          <a href="http://localhost:8080/ttapp/Teammember.jsp" class="txt2">
