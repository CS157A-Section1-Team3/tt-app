  ...
  <form class="contact100-form validate-form">
    ...
    <div class="container-contact100-form-btn">
      <button class="contact100-form-btn">
        <span>
          <a href="http://localhost:8080/FullHistory.jsp" class="txt2">
     ...
     String db = "Time";
        ...
        try {
          ...
          //  out.println("Initial entries in table SHIFT: <br/>");
            ...
            ResultSet rs = stmt.executeQuery("SELECT SHIFT.Id, SHIFT.pid, SHIFT.start, SHIFT.end, Hours.hWorked FROM Time.SHIFT, Time.Hours WHERE SHIFT.Id = 1 AND Hours.SHIFTId = SHIFT.Id;");
            while (rs.next()) {
